...
public class FileLog {
	...
	/** 
	 * Advances the rotation counter by one place, and resets if above threshhold
	 */
	 ...
	 * @return int between 0 and 10 (log levels 1 or 2) or between 0 and 25 (log level 3)
	 */
