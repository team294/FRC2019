...
public class RobotPreferences {
	...
	public void refresh() {
		...
		elevatorGearCircumference = prefs.getDouble("Circumference", 1); // Conversion factor for makeshift elevator18/32.3568952084); //TODO change values when elevator is built
