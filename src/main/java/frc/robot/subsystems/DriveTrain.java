...
public class DriveTrain extends Subsystem {
  ...
  private int periodicCount = 0; // increments every cycle
  private int idleCount = 0; // increments every cycle the drive train isn't moving
  private double prevEnc = 0.0;
  private double currEnc = 0.0;

  private int leftMotorFaultCount = 0; // increments every cycle the left side detects an issue
  private int rightMotorFaultCount = 0; // increments every cycle the right side detects an issue
  ...
  public void tankDrive(double powerLeft, double powerRight) {
    /* if (Robot.log.getLogLevel() == 1) {
      Robot.log.writeLog("DriveTrain", "Percent Power Set", "Left," + powerLeft + ",Right," + powerRight);
  ...
  public void zeroLeftEncoder() {
    Robot.log.writeLog("DriveTrain", "Zero Drive Enc", "Left");
  ...
  public void zeroRightEncoder() {
    Robot.log.writeLog("DriveTrain", "Zero Drive Enc", "Right");
  ...
  public void updateDriveLog() {
    Robot.log.writeLog("DriveTrain", "Update Variables",
        "VoltsL1," + leftMotor1.getMotorOutputVoltage() + ",VoltsL2," + leftMotor2.getMotorOutputVoltage() + ",VoltsL3," + leftMotor3.getMotorOutputVoltage() + 
        ",AmpsL1," + Robot.pdp.getCurrent(RobotMap.leftMotor1PDP) + ",AmpsL2," + Robot.pdp.getCurrent(RobotMap.leftMotor2PDP) + ",AmpsL3," + Robot.pdp.getCurrent(RobotMap.leftMotor3PDP) + 
        ",VoltsR1," + rightMotor1.getMotorOutputVoltage() + ",VoltsR2," + rightMotor2.getMotorOutputVoltage() + ",VoltsR3," + rightMotor3.getMotorOutputVoltage() + 
        ",AmpsR1," + Robot.pdp.getCurrent(RobotMap.rightMotor1PDP) + ",AmpsR2," + Robot.pdp.getCurrent(RobotMap.rightMotor2PDP) + ",AmpsR3," + Robot.pdp.getCurrent(RobotMap.rightMotor3PDP) + 
        ",L EncTicks," + getLeftEncoderTicks() + ",L EncInches," + getLeftEncoderInches() + 
        ",R EncTicks," + getRightEncoderTicks() + ",R EncInches," + getRightEncoderInches() + 
  ...
  public void driveToCrosshair(double quadrant) {
    ...
    if (Robot.log.getLogLevel() <= 2) {
      Robot.log.writeLogEcho("DriveTrain", "Vision Tracking",
          "Crosshair Horiz Offset," + xVal + ",Inches from Target," + Robot.vision.distanceFromTarget()
              + ",Target Area," + area + ",Joystick Ouput," + lJoystickAdjust + ",Left Percent," + lPercentOutput
              + ",Right Percent," + rPercentOutput);
    }
  }
